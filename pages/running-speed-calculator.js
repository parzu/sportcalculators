...
export default () => (
  <Layout>
    ...
    <p>
      Calculate running speed from time and distance. Calculator shows the
    ...
    <p>
      Insert your total running time in hours, minutes and seconds fields.
      Insert also your running distance and select the unit you want to use for
      distance. The calculator will calculate the speed in most used units.
    </p>
    <p>
      Speed is calculated by dividing running distance with used time.
    ...
    <p>
      The calculator also calculates running pace. This indicates how many
