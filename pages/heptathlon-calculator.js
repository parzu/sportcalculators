...
export default function HeptathlonCalcPage(props) {
  ...
  return (
    <Layout>
      ...
      <p>
        With this heptathlon calculator you can calculate heptathlon points from
        results and results from points. Use the results from points calculation
      ...
      <p>
        The heptathlon calculator is easy to use. Select the calculation
      ...
      <h3>Heptathlon</h3>
      <p>
        Heptathlon is a combined events contest consisting of seven events.
        Events are competed on track or field. There are two types of
        heptathlons. One is women's outdoor heptathlon and the other is men's
        indoor heptathlon. This heptathlon calculator is for women's heptathlon.
        Outdoors men usually compete on decathlon (see{" "}
        <a href="/decathlon-calculator">decathlon calculator</a>). Scoring over
        7000 points in heptathlon is very rare and it has been done only few
        times.
      </p>

      <p>
        Women's heptathlon consists of the following events. First four of them
        are competed on the first day, and the rest on the second day:
      </p>
      <ul>
      ...
      <p>
        Before the early 1980s women's primary combined event contest was
        pentathlon. Pentathlon was replaced by heptathlon in the 1984 Olympic
        games. 200 meters run and javelin throw were added to the pentathlon.
        Also the hurdles race got longer from 60m to 100m. In the recent years
        women's decathlon competitions has also been conducted. It consists of
        same events than men's decathlon but with different order. Also the
        calculation table is different so men's decathlon calculator cannot be
        used to calculate women's decathlon.
      </p>

      <p>
        IAAF (International Association of Athletics Federations) has good site
        for heptathlon. They also keep up the records from competitions around
        the world. You can read more on their{" "}
        <a
          href="https://www.iaaf.org/disciplines/combined-events/heptathlon"
          target="_blank"
        >
          site
        </a>
      ...
      <p>
        Here's a brief introduction on how the heptatlon points are calculated.
        Read this article for more indepth explanation on{" "}
        <a href="/heptathlon-scoring">heptathlon scoring</a>.
      </p>
