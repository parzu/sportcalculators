...
export default () => (
  ...
  <p>This is a simple calculator for calculating your bowling handicap. Use it together with our bowling score calculator and you don't need any other bowling related calculators.</p>
  <div style={{paddingTop: "40px", paddingBottom: "40px"}}>
    <BowlingHandicapCalculator></BowlingHandicapCalculator>
  </div>
  <h3>How to Use the Calculator?</h3> 
  <p>Just enter your bowling average, basis score and percentage factor and press calculate to get your handicap. You can also enter your game score to calculate adjusted score.</p>
  ...
  <p>To find out your average add the scores from your previous games and divide the result with the number of games. If you are bowling in a league you probably must use game scores from league games. Otherwise, once again, you can decide the number of games with your competitors. Let's say you decided to use three previous games with scores 157, 143 and 142. The sum of these is 442 and when you divide it with 3 you get 147.3 pins per game. Drop a fraction of a pin and your official average is 147.</p>

  <p>Subtract your average from the basis score and multiply the result with the percentage factor. Let's say that the basis score is 200 and the percentage factor is 90%. You get (200-147)x0.9=47.7. Once again drop the fraction and your handicap is 47. To get your adjusted score, simply add the handicap to your game score. For example if you get 143, your adjusted score is 190. Try this out with the bowling handicap calculator above.</p>
  ...
  <div style={{textAlign: "center", position: "relative", overflow: "hidden", paddingTop: "56.25%"}}>
    <iframe style={{
      ...
      maxWidth: "560px",
      maxHeight: "315px",
      border: "0"}} width="560" height="315" src="https://www.youtube.com/embed/klZrNT5ns_M" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
    </iframe>
  </div>
